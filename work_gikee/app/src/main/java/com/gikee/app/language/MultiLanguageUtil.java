package com.gikee.app.language;
...
public class MultiLanguageUtil {
    ...
    public static Locale getLanguageLocale() {
        ...
        int languageType = PreferenceUtil.getInt(MultiLanguageUtil.SAVE_LANGUAGE, 0); //CommSharedUtil.getInstance(mContext).getInt(MultiLanguageUtil.SAVE_LANGUAGE, 0);
    ...
    public void updateLanguage(int languageType) {
        PreferenceUtil.commitInt(MultiLanguageUtil.SAVE_LANGUAGE, languageType);
...
//        int languageType = PreferenceUtil.getInt(MultiLanguageUtil.SAVE_LANGUAGE, 0);//CommSharedUtil.getInstance(context).getInt(MultiLanguageUtil.SAVE_LANGUAGE,LanguageType.LANGUAGE_FOLLOW_SYSTEM);
...
//    }
    ...
    public int getLanguageType() {
        int languageType = PreferenceUtil.getInt(MultiLanguageUtil.SAVE_LANGUAGE, 0);//CommSharedUtil.getInstance(mContext).getInt(MultiLanguageUtil.SAVE_LANGUAGE, LanguageType.LANGUAGE_FOLLOW_SYSTEM);
